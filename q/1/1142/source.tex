...
\begin{center}
  \begin{tabular}{NlN}
   ...
   \midrule 
   p & \text{Drawing a single}  & \frac{1}{3} \\
   & \text{defective bulb} & \\
    \midrule 
    q & \text{Drawing a single}  & \frac{2}{3} \\
    & \text{non-defective bulb} & \\
    \bottomrule
  \end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{NlN}
   \toprule
        \text{Probability} &  Of & \text{Value} \\
   \midrule 
   p & \text{Drawing a single} & \frac{1}{2} \\
   & \text{defective bulb} & \\
    \midrule 
    q & \text{Drawing a single} & \frac{1}{2} \\
    & \text{non-defective bulb} & \\
    \bottomrule
  \end{tabular}
\end{center}
...
\begin{tabular}{cNNNNN}
      ...
      & k=0 & 1 & 2 & 3 & 4 \\
      \midrule
      \text{Probability $(P_k)$} & \frac{16}{81} & \frac{32}{81} & \frac{8}{27} & \frac{8}{81} & \frac{1}{81} \\
      \midrule 
      \text{Value $(k)$} & 0 & 1 & 2 & 3 & 4 \\
      \bottomrule
      \end{tabular}
\end{center}
